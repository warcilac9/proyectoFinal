import {
  ...
  export default function Input(){
   return <div className="flex  border-b border-gray-200 p-3 space-x-3">
    <img src="https://avatars.githubusercontent.com/u/117041814?v=4" alt="user-img" className="h-11 w-11 rounded-full cursor-pointer hover:brightness-95"/>
